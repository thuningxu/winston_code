...
FPS = 1000000000000000000000000000000000
...
start_img = pygame.transform.scale(pygame.image.load('images/start_btn.png').convert_alpha(), (260, 100))
exit_img = pygame.transform.scale(pygame.image.load('images/exit_btn.png').convert_alpha(), (260, 100))
...
start_button = button.Button(SCREEN_WIDTH // 2 - 130, SCREEN_HEIGHT // 2 - 200, start_img, 1)
exit_button = button.Button(SCREEN_WIDTH // 2 - 130, SCREEN_HEIGHT // 2 + 100, exit_img, 1)
restart_button = button.Button((SCREEN_WIDTH // 2) - (restart_img.get_width() / 2), (SCREEN_HEIGHT / 2) - (restart_img.get_height() // 2), restart_img, 2)
