...
class GameManager:
	...
	def reset_ball(self):
		...
		if self.ball_group.sprite.rect.left <= 0:
			self.opponent2_score += 1
			self.ball_group.sprite.reset_ball()

	def draw_score(self):
		opponent2_score = basic_font.render(str(self.opponent2_score),True,accent_color)
		opponent_score = basic_font.render(str(self.opponent_score),True,accent_color)

		opponent2_score_rect = opponent2_score.get_rect(midleft = (screen_width / 2 + 40,screen_height/2))
		opponent_score_rect = opponent_score.get_rect(midright = (screen_width / 2 - 40,screen_height/2))

		screen.blit(opponent2_score,opponent2_score_rect)
...
# Game objects
opponent2 = Opponent2('images/Paddle.png',screen_width - 20,screen_height/2,5)
