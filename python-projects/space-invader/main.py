...
class Game:
	def __init__(self):
		...
		self.alien_setup(rows = 100, cols = 100)
		...
		music.play(loops = -1)
		self.laser_sound = pygame.mixer.Sound('sound/audio_laser.wav')
		self.laser_sound.set_volume(0.5)
		self.explosion_sound = pygame.mixer.Sound('sound/audio_explosion.wav')
