...
class SNAKE:
    def __init__(self):
        self.body = [V2(0,2),V2(0,1),V2(0,0)]
        ...
        self.crunch_sound.set_volume(0.75)
    ...
    def control_snake(self):
        move_up = False
        if self.body[0].y == 19 and self.direction == V2(0,1):
            self.direction = V2(1,0)
            self.move_snake()
            self.direction = V2(0,-1)
        elif self.body[0].y == 1 and not self.body[0] == V2(19,1) and self.direction == V2(0,-1):
            self.direction = V2(1,0)
            self.move_snake()
            self.direction = V2(0,1)
        elif self.body[0] == V2(19,19):
            self.direction = V2(0,-1)
        elif self.body[0] == V2(19,0):
            self.direction = V2(-1,0)
        elif self.body[0] == V2(0,0):
            self.direction = V2(0,1)
...
bg_sound = pygame.mixer.Sound('sound/snake-sound.mp3')
